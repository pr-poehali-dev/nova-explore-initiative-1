  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-11 p-6">
      <div className="flex justify-between items-center">
        <div className="text-white text-2xl uppercase tracking-wide font-bold">БТК</div>
          ...
          <div className="flex flex-col items-end gap-1">
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-white hover:text-neutral-400 transition-colors duration-300 text-lg font-medium"
              >
                +7 951 535-03-50
              </a>
              <a
